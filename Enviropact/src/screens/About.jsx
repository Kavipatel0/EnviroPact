            ...
            <div className="p-12 py-4 max-w-full">
                ...
                <div className="p-10 flex flex-row items-center justify-center space-x-32">
                    ...
                    <Card style={{ width: 500 }}>
                        ...
                        <h2 className="pt-6 flex justify-center text-3xl font-bold geist-reg">Kavi Patel</h2>
                        <p className="p-2 flex justify-center text-lg geist-reg">Placeholder</p>
                        <p className="pb-4 text-zinc-600 flex justify-center text-lg geist-reg">Backend</p>
                ...
                <div className="p-10 flex flex-row items-center justify-center space-x-32">
                    <Card style={{ width: 500 }}>
                        ...
                        <h2 className="pt-6 flex justify-center text-3xl font-bold geist-reg">Stanley Ke</h2>
                        <p className="p-2 flex justify-center text-lg geist-reg">Placeholder</p>
                        <p className="pb-4 text-zinc-600 flex justify-center text-lg geist-reg">Frontend</p>
                        <div className="flex justify-center space-x-2">
                    ...
                    <Card style={{ width: 500 }}>
                        ...
                        <h2 className="pt-6 flex justify-center text-3xl font-bold geist-reg">Logan Bjork</h2>
                        <p className="p-2 flex justify-center text-lg geist-reg">Placeholder</p>
                        <p className="pb-4 text-zinc-600 flex justify-center text-lg geist-reg">Frontend</p>
                        <div className="flex justify-center space-x-2">
